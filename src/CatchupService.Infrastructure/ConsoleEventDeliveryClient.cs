...
public sealed class ConsoleEventDeliveryClient : IEventDeliveryClient
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        Console.WriteLine(
            $"[test-delivery] subscription={subscription.SubscriptionId} event={@event.EventId} type={@event.EventType} stream={@event.StreamName} sequence={@event.SequenceNumber} payload={payload}");
